...
import com.hyw.mobileguard.utils.Md5Utils;
...
//	 R.drawable.settings };
	...
	private String[] names = { "手机防盗", "通讯卫士", "软件管家", "进程管理", "高级工具", "设置中心" };
	private int[] icons = { R.drawable.safe, R.drawable.callmsgsafe,
			R.drawable.app_selector, R.drawable.taskmanager, R.drawable.atools,
			R.drawable.settings };
